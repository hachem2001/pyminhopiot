...
NodeLP_fastflood_mod.NODE_RECEPTION_OF_PACKET_DURATION = NodeLP_slowflood_mod.NODE_RECEPTION_OF_PACKET_DURATION = NodeLP_slowflood_mod.NODE_RECEPTION_OF_PACKET_DURATION = NodeLP.NODE_RECEPTION_OF_PACKET_DURATION
...
for node_class_index in range(len(node_classes)):
    ...
    for suppression_mode in suppression_modes[node_class_index]:
        for sample in range(NUM_OF_SAMPLES):
            ...
            aggregate_logs_and_save(LOGGERS_CONSIDERED, "saved_logs/tld6s_"+label_names[counter_label_name]+"_"+str(sample+START_COUNT_SAVE))
